...
**Features** : F-010, F-011, F-012, F-020, F-021, F-022, F-024, F-026.

**Démo de sortie**

Créer une offre et un ICP publiés, importer une liste, résoudre les doublons,
consulter les fiches et exclure un contact.
...
3. F-010 : première vertical slice métier complète ;
4. F-011 : répéter le pattern de version immuable ;
