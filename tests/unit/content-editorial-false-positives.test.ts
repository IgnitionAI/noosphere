...
test('a historical three-page comparison is blocked while carousels are unavailable',()=>{
expect(evaluateContentReadiness({...input,draft:{...input.draft,mediaPlan}})).toEqual({ready:false,blockers:["format_unavailable"]});
});
