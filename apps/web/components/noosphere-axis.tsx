      ...
      {lenses.map((candidate) => {
        ...
        return (
          <Link
            ...
            className={`flex min-h-11 min-w-0 items-center justify-center rounded-full px-2 py-2.5 text-center text-xs font-bold transition sm:text-sm ${selected ? "bg-signal text-signal-ink shadow-sm" : "text-muted hover:bg-white hover:text-ink"}`}
