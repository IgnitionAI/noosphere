      ...
      <main className="min-h-screen bg-canvas px-4 py-8 sm:px-6 lg:py-12">
        <div className="mx-auto max-w-5xl">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div><div className="badge badge-signal w-fit">Configuration guidée</div><h1 className="mt-4 text-3xl font-semibold text-ink">Rendez {workspace.name} opérationnel</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-muted">Chaque validation repose sur les vraies données du workspace. Vous pouvez quitter et reprendre sans rien perdre.</p></div>
            <div className="flex items-center gap-3"><span className="text-sm font-semibold text-ink">{progress.completedCount}/7 étapes</span><Link className="button" href={`/w/${workspace.slug}/strategy/product-reading`}>Ouvrir l’app</Link></div>
          </div>
