...
export default async function MessagingPage({ params }: { params: Promise<{ workspaceSlug: string }> }) {
  ...
  return (
    <>
      ...
      {strategy && !policy ? <CreateMissing title="Créer une politique de supervision" action={createAIPolicyAction.bind(null, workspaceSlug)} canEdit={canEdit} /> : null}
