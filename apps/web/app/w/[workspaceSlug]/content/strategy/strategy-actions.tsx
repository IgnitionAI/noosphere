...
export function StrategyActions({ workspaceSlug, hasStrategy, currentVersion, preparing = false }: { preparing?: boolean; workspaceSlug: string; hasStrategy: boolean; currentVersion: number }) {
  ...
  return (
    <div className="flex w-full flex-wrap items-center gap-2 sm:w-auto sm:justify-end">
      ...
      <button className="button w-full sm:w-auto" disabled={pending !== null || preparing} onClick={() => run("derive")} type="button">
        {pending === "derive" || preparing ? "Préparation en cours…" : hasStrategy ? "Recalculer depuis l’offre et l’ICP" : "Préparer la stratégie"}
      </button>
