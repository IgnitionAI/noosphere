...
function blockerLabel(blocker: string) { if (blocker.startsWith("editorial_") && !["editorial_blocker", "editorial_assessment_missing", "editorial_assessment_invalid", "editorial_policy_outdated"].includes(blocker)) return qualityCriterionLabel(blocker.slice("editorial_".length)); return ({ editorial_policy_outdated: "Version à réévaluer", editorial_assessment_missing: "Évaluation éditoriale à refaire", editorial_assessment_invalid: "Évaluation éditoriale incomplète", unsupported_claim: "Fait non prouvé", unaudited_claim: "Fait non audité", ungrounded_statement: "Phrase non sourcée", forbidden_topic: "Sujet interdit", generic_language: "Langage générique", audit_language: "Métalangage d’audit", too_long: "Post trop long", multiple_questions: "Trop de questions", source_paraphrase: "Résumé de source", unpublishable_media: "Visuel non publiable", repetition: "Répétition", cta_misaligned: "CTA hors offre", editorial_blocker: "Critique bloquante" } as Record<string, string>)[blocker] ?? blocker; }
