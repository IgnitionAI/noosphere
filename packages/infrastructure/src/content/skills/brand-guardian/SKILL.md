...
3. For a carousel, carry one argument across the sequence. The cover makes an accurate reading promise; the middle demonstrates it; the closing gives the decision or takeaway. Include all essential reasoning in the visible slide fields. The caption and slides may share a central term but should complement each other.
